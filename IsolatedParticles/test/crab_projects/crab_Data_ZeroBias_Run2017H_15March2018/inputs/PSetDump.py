...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/data/Run2017H/ZeroBias/RAW-RECO/LogError-PromptReco-v1/000/306/896/00000/E2DE682A-60D0-E711-B583-02163E01A1BF.root')
)
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('StudyHLT_H_15March.root')
)

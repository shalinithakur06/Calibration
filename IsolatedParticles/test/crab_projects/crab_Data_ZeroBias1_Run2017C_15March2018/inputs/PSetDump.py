...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/data/Run2017C/ZeroBias1/RAW-RECO/LogError-PromptReco-v2/000/299/996/00000/005ACA51-1B76-E711-9F6D-02163E01A2F9.root')
)
...
process.studyHLT = cms.EDAnalyzer("StudyHLT",
    ...
    triggers = cms.untracked.vstring('HLT'),
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('StudyHLT_C_15March.root')
)
